...
class TestCanonicalize(unittest.TestCase):
    ...
    def test_canonicalize_url_strip(self):
        for url, canon in [
            ...
            ('https://downloads.sourceforge.net/prjname/prjname-2.73.tar.gz',
             '//sourceforge.net/projects/prjname'),
            ('https://downloads.sf.net/prjname/prjname-2.73.tar.gz',
             '//sourceforge.net/projects/prjname'),
            ...
            ('https://xyzzy.github.io/repo.htm', '//github.com/xyzzy/repo'),
            ('https://xyzzy.github.io/repo.xhtml', '//github.com/xyzzy/repo'),
            ('https://xyzzy.github.io/super.duper', '//github.com/xyzzy/super.duper'),
            ...
            ('https://pagure.io/project/', '//pagure.io/project'),
            ('https://pagure.io/two/level', '//pagure.io/two/level'),
            ('https://pagure.io/two/level/', '//pagure.io/two/level'),
            ('https://pagure.io/two/level/more/internal/stuff', '//pagure.io/two/level'),
            ('https://pagure.io/single/tree/master', '//pagure.io/single'),
            ('https://pagure.io/single/releases', '//pagure.io/single'),
            ('https://pagure.io/golist/archive/v0.10.3/golist-0.10.3.tar.gz', '//pagure.io/golist'),
            ('https://pagure.io/fedora-rust/python-rustcfg/archive/0.0.2/python-rustcfg-0.0.2.zip',
             '//pagure.io/fedora-rust/python-rustcfg'),
            ('https://releases.pagure.org/some-project/', '//pagure.io/some-project'),
            ('https://releases.pagure.org/dlm/dlm-4.3.0.tar.gz', '//pagure.io/dlm'),
            ('https://releases.pagure.org/fedora-rust/obs-service-rust2rpm/obs-service-rust2rpm-1.tar.gz',
             '//pagure.io/fedora-rust/obs-service-rust2rpm'),
            ('https://releases.pagure.org/first/', '//pagure.io/first'),
            ('https://src.fedoraproject.org/rpms/nodejs-packaging/blob/rawhide/f/README.md',
             '//src.fedoraproject.org/rpms/nodejs-packaging'),
            ('https://gitlab.com/user-only/', '//gitlab.com/user-only'),
            ('https://gitlab.com/user-only/proj', '//gitlab.com/user-only/proj'),
            ('https://gitlab.com/user-only/proj.git', '//gitlab.com/user-only/proj'),
            ('https://gitlab.com/user/proj/-/archive/0.9.12/proj-0.9.12.tar.gz', '//gitlab.com/user/proj'),
    ...
    def test_canonicalize_url_nostrip(self):
        for url, canon in [
            # This multilevel gitlab URL is not yet supported
            ('https://gitlab.com/user/1st/second', 'https://gitlab.com/user/1st/second'),
            ('https://gitlab.com/user/1st/upload', 'https://gitlab.com/user/1st/upload'),
            # These special pagure URLs are not yet supported
            ('https://pagure.io/docs/project', 'https://pagure.io/docs/project'),
            ('https://pagure.io/api/0/project', 'https://pagure.io/api/0/project'),
